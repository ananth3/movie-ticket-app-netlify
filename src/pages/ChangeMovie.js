...
const ChangeMovie = (props) => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      await axiosInstance.put("/movie/61bc271716ee437d4fbac0b3", newMovie);
      await axiosInstance.get("/ticket/reset/all-tickets");
      await axiosInstance.get("/seat/reset/all-seats");
      history.push("/");
